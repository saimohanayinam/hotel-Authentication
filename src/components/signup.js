...
const Signup = () => {  
    ...
    const enteredNameTouched = useSelector(state=> state.signup.signupNameTouched)
    ...
    const nameInputIsInvalid = !enteredPasswordIsValid && !enteredNameIsValid && enteredNameTouched;
    ...
    <form onSubmit={formSubmissionHandler}>
      <div className={nameInputClasses}>
        ...
        <input
          ...
          />
        {nameInputIsInvalid && (
          <p className='error-text'>Password should have atleast 5 characters </p>
          )}
      </div>
      <div className='form-actions'>

      <Link to="/Done"  > <button disabled={!formIsValid}> Signup </button></Link>
